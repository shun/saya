use crate::app::event_loop::EventSender;
use crate::presentation::screen_model::ScreenCursorStyle;
use crate::presentation::ui_surface::UiSurfaceMode;
use crate::terminal::capability::{TerminalCapabilityProbeService, TerminalCapabilityProfile};
use crate::terminal::input_loop::{TerminalEventSource, run_terminal_input_loop};
...
impl<'a, B: TerminalBackend> TerminalIoBroker<'a, B> {
    pub fn begin_session(
        ...
        let session = crate::terminal::lifecycle::TerminalLifecycle::start(backend)
