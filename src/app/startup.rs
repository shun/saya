use crate::app::bootstrap::{BootstrapError, BootstrapOutcome, prepare_launch};
use crate::app::cli::LaunchRequest;
use crate::presentation::ui_surface::{
    PolicyViolation, UiFeatureRequest, UiSurfacePolicy, UiSurfacePolicyService,
};
use crate::runtime::integration::RuntimeSessionOwner;
use crate::runtime::live::RuntimeInitError;
use crate::support::diagnostic_log::configure_from_startup as configure_diagnostic_log_from_startup;
use crate::terminal::capability::{TerminalCapabilityProbeService, TerminalCapabilityProfile};
use crate::terminal::io_broker::{TerminalIoBroker, TerminalIoBrokerError};
use crate::terminal::lifecycle::{TerminalBackend, TerminalStartError};
