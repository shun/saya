    ...
    fn from(value: SelectorHighlight) -> Self {
        Self {
            ...
            kind: match value.kind {
                crate::selector_core::HighlightKind::Match => RuntimeSelectorHighlightKind::Match,
                crate::selector_core::HighlightKind::Selection => {
                    RuntimeSelectorHighlightKind::Selection
                }
                crate::selector_core::HighlightKind::Diagnostic => {
